...
### Члены класса
* Класса хранит коэффициент функии ***a***,
* Перегрузить виртуальные функции ***getValue*** и ***getDerivative***,
* В вышеупомянутых функциях, если переданный аргумент ***x*** равняется нулю,
поднять исключение ***std::invalid_argument*** с сообщением ***"Divided by zero"***.
...
и вывести сообщение внутри исключения. 
